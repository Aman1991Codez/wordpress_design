<?php
	...
	?>
		<div class="wrap mabuc_wrap">
			<h2><?php echo $themename; ?> <p class="version"><?php echo "version " . $version; ?></strong></p></h2>
			<div class="mabuc_opts">
				<p>
					<?php _e( 'Enter your Settings for', CODEEX_THEME_NAME ); ?> <?php echo $themename . "."; ?> 
					<?php _e( 'If you have any questions please refer to the user manual.', CODEEX_THEME_NAME ); ?>
				</p>	
				<form method="post" >
				<?php 
	...
	case "section":
		...
		<div class="mabuc_section">
			<div class="mabuc_title">
				<h3><i class="<?php echo $value['icon']; ?>"></i><?php echo $value['name']; ?> <span><?php _e( 'open', CODEEX_THEME_NAME ); ?></span></h3>
	...
	case 'img_preview':
		...
		<div class="mabuc_input mabuc_textarea">
			...
			<div class="ipreview">
				<?php
					if ( get_option( $value['id'] ) != "") { ?><img src="<?php echo stripslashes(get_option( $value['id'])  ); ?>" style="background:#EEE;"><?php }
				?>
			</div>
			<div class="clearfix"></div>
		</div>		
...
?>
		...
		<div class="btn-actions">
			...
			<span><input name="support" type="button" value="Ask for Help?" class="button-primary" onClick="window.open('<?php echo $help; ?>')" /></span>	
